---
title: "Worker pool, baseline workers, and demand scaling"
description: "How Malbox workers consume tasks from the shared queue, scale on demand via baseline and demand workers, and report results back to the scheduler."
---
