---
title: "Set up a Malbox development environment with Nix"
description: "Clone Malbox and enter the Nix flake dev shell to get Rust, PostgreSQL, Packer, Ansible, and cross-compilation toolchains ready for contributing."
---
...
2. The backend is running (`cargo run -p malbox-daemon`)
