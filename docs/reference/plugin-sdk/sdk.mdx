---
title: "Malbox Plugin SDK API reference"
description: "API reference for the Malbox Plugin SDK across Rust, C++, and Python, covering plugin traits, lifecycle methods, and host and guest deployment."
---
