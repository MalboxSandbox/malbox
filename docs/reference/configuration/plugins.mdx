---
title: "plugin.toml configuration reference"
description: "Complete schema reference for the plugin.toml manifest, including runtime settings, paths, execution contexts, and event subscription fields."
---
