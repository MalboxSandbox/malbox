---
title: "Worker configuration reference"
description: "All worker and worker pool settings in malbox.toml, including max_workers, min_workers, idle_timeout_ms, and per-worker execution configuration."
---
