...
- **Front-end cleanup.** Removed an unused, deprecated score bar component left over from the [report UI redesign](/changelog#may-15-2026). No user-facing changes — the new report layout introduced last week remains the default.

This was a quiet week focused on internal cleanup and documentation polish. Larger product changes resume in the next release.
