---
title: "Introduction to Malbox malware analysis platform"
description: "Malbox is an open-source, plugin-based malware analysis platform for security researchers, with flexible machinery and a modern extensible architecture."
---
