---
title: "Machinery providers: machine allocation and snapshots"
description: "How Malbox providers create, destroy, and snapshot analysis machines across infrastructure platforms using the capability-based provider system."
---
