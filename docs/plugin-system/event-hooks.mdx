---
title: "Event hooks and the plugin pub/sub model"
description: "How Malbox plugins subscribe to per-plugin and daemon broadcast event channels, route handlers via on_event, and react to task and sample events."
---
